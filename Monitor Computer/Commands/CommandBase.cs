...
#pragma warning disable CS0693 // Type parameter 'T' has the same name as the type parameter from outer type 'CommandBase<T>'
        /// <summary>
...
#pragma warning restore CS0693 // Type parameter 'T' has the same name as the type parameter from outer type 'CommandBase<T>'
